...
/**
 * 更新会话字段（summary、titleAutoGenerated、summaryGenerated、title）
 * 对应 Rust 后端 update_chat_session_fields 命令
 */
export const updateSessionFields = (
  ...
  tryCMD<ChatSession>('update_chat_session_fields', {
    id,
    summary: fields.summary ?? null,
    titleAutoGenerated: fields.titleAutoGenerated ?? null,
    summaryGenerated: fields.summaryGenerated ?? null,
