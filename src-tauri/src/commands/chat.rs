...
pub async fn update_chat_session_title(
    ...
    service.update_session_title(id, title)
        .await
        .map_err(|e| e.to_string())
}
...
pub async fn get_chat_messages(
    ...
    service.get_messages_by_session(session_id)
        .await
        .map_err(|e| e.to_string())
}
...
pub async fn update_chat_message_state(
    ...
    service.update_message_state(id, state)
        .await
        .map_err(|e| e.to_string())
}
...
pub async fn update_chat_message_content(
    ...
    service.update_message_content(id, content, tokens)
        .await
        .map_err(|e| e.to_string())
}
