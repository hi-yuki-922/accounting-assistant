...
use super::dto::{
    ...
    RecordWithCountDto, RecordWriteOffDetailsDto, UpdateBookDto, WriteOffRecordDto,
};
...
impl AccountingBookService {
    ...
    pub async fn get_records_by_book_id_paginated(
        ...
        // 固定过滤条件：只查询 write_off_id 为 NULL 的记录
