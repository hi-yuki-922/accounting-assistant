...
| category        | 品类管理 | category, category_seq                                 |
| chat            | AI 聊天  | chat_session, chat_message_seq, section_summary        |
| customer        | 客户管理 | customer, customer_seq                                 |
| product         | 商品管理 | product, product_seq；通过 category_id 关联 category   |
