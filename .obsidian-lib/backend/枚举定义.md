...
pub mod customer;
pub mod order;
pub mod order_sub_type;

pub use accounting::*;
pub use chat::*;
pub use customer::*;
pub use order::*;
pub use order_sub_type::*;
```
...
| `chat.rs`           | `MessageRole`           | User, Assistant, System                                         |
| `chat.rs`           | `MessageState`          | Sending, Sent, Completed, Failed                                |
...
| `order_sub_type.rs` | `OrderSubType`          | Wholesale, Retail, WholesalePurchase, PeerTransfer              |
